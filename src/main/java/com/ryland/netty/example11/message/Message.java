...
/**
 * keys to customize msg
 * 1. magic: filter invalid datagram at the first time
 * 2. version: for upgrading
 * 3. algorithm for serialization: json, protobuf, hessian, jdk
 * 4. instruction type: login in, register, chat, group chat...(about business)
 * 5. sequence id: for duplex communication
 * 6. context length
 * 7. context
 *
 * @author Ryland
...
public abstract class Message implements Serializable {
    ...
    /**
     * get Class according to message type
     */
